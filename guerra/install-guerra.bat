@echo off
:: ═══════════════════════════════════════════════════════════
::  Guerra 1.21.1 Modpack Installer for Windows
::  Downloads and installs client mods automatically
:: ═══════════════════════════════════════════════════════════
setlocal enabledelayedexpansion

title Guerra 1.21.1 — Mod Installer

echo.
echo  ╔══════════════════════════════════════════════════╗
echo  ║     Guerra 1.21.1 — Modpack Installer           ║
echo  ║     NeoForge · 50 Mods · Ready to Battle        ║
echo  ╚══════════════════════════════════════════════════╝
echo.
...
echo    4. Launch and connect to: pcanabarro.dev:25566
echo.
echo  ═══════════════════════════════════════════════════
echo.
